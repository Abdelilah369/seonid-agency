    ...
    ? [
        {
          ...
          headline: "أداء مُهندَس وفق ميزانية محددة، لا وفق لقطة شاشة.",
          desc: "بنى رقمية نظيفة خالية من حشو القوالب الجاهزة. عرض من خوادم الحافة العالمية بميزانية تحميل دون الثانية ووسائط تُحمَّل عند الحاجة فقط — مُتحقق منها بقياسات حقيقية، لا بأرقام تسويقية.",
          specs: [
            { label: "طريقة العرض", val: "ثابت افتراضيًا (SSG)" },
            { label: "وسائط الواجهة", val: "720p · ~1.4 MB · تحميل كسول" },
            { label: "حجم الصفحة", val: "~120 KB نقلًا" },
        ...
        },
        {
          ...
          desc: "لم يعد تصدر Google كافياً إذا كانت نماذج الذكاء الاصطناعي لا تستشهد بك. نربط موقعك بـ JSON-LD Entity Graph متقدم يجعل نشاطك مصدرًا موثوقًا تستشهد به النماذج.",
          specs: [
            { label: "مخطط البيانات المنظمة", val: "Org, Service, FAQ, Breadcrumb" },
            { label: "محركات البحث المدعومة", val: "ChatGPT, Perplexity, Claude" },
            { label: "مخططات الكيانات", val: "Article, Org, FAQ, Service" },
            { label: "صحة الفهرسة", val: "بنية نظيفة بدون فوضى" },
          ],
        },
        {
          num: "03",
          ...
          headline: "أتمتة العمليات مع إبقاء الإشراف البشري حيث يلزم",
          desc: "بناء مسارات عمل ذاتية التشغيل تربط التقاط العملاء من الموقع مباشرة بـ CRM (HubSpot/Notion) وإرسال العروض والمقترحات آلياً.",
          specs: [
            { label: "محرك الأوركسترا", val: "n8n Dedicated" },
            { label: "حدث العميل", val: "Webhook → CRM" },
            { label: "نطاق الأتمتة", val: "التقاط العملاء، المستندات، المزامنة" },
    ...
    : [
        {
          ...
          headline: "Performance engineered to a budget, not to a screenshot.",
          desc: "Custom headless architectures without bloated WordPress plugins. Global edge rendering with a sub-second load budget and lazy-loaded media — verified with real measurements, not marketing numbers.",
          specs: [
            { label: "Rendering", val: "Static-by-default (SSG)" },
            { label: "Hero media", val: "720p · ~1.4 MB · lazy" },
            { label: "Page weight", val: "~120 KB transfer" },
        ...
        },
        {
          ...
          desc: "Ranking #1 on Google is no longer enough if AI search overviews overlook your brand. We build deep JSON-LD entity graphs that position your platform as a citable source for LLMs.",
          specs: [
            { label: "Schema Graph", val: "Org, Service, FAQ, Breadcrumb" },
        ...
        },
        {
          ...
          headline: "Workflow automation with a human-in-the-loop where it matters",
          ...
          specs: [
            ...
            { label: "Lead Event", val: "Webhook → CRM" },
            { label: "Automation scope", val: "Lead capture, docs, sync" },
