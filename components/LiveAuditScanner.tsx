...
const COPY = {
  en: {
    ...
    ctaFull: "Get the Full 48h Audit",
  ...
  fr: {
    ...
    pass: "OK",
    fail: "Manquant",
    disclaimer: "Ceci est un pré-diagnostic automatisé rapide sur 7 signaux de surface — il ne remplace pas un audit technique complet. C'est ce que couvre le livrable de 48h.",
    ctaFull: "Obtenir l'audit complet 48h",
  ...
  ar: {
    ...
    pass: "ناجح",
    fail: "مفقود",
    disclaimer: "هذا فحص آلي سريع لـ 7 مؤشرات سطحية — لا يغني عن تدقيق تقني كامل. هذا ما يغطيه التقرير خلال 48 ساعة.",
    ctaFull: "احصل على التدقيق الكامل خلال 48 ساعة",
