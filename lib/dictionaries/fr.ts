...
const fr: Dictionary = {
  nav: {
    ...
    srvWebTitle: "Ingénierie Web",
    srvWebDesc: "Sites Next.js rapides, avec un budget de performance.",
    srvSeoTitle: "SEO Technique & B2B",
    srvSeoDesc: "Crawl, indexation, schémas — des correctifs qui comptent.",
    srvGeoTitle: "GEO / Recherche IA",
    srvGeoDesc: "Faites-vous citer par ChatGPT & Perplexity.",
    auditLink: "Démarrer un projet",
    auditDesc: "Obtenez une feuille de route technique gratuite en 14 points.",
    insBenchTitle: "Le benchmark des 12 agences",
    insBenchDesc: "Pourquoi 83 % des sites marocains échouent aux Core Web Vitals.",
    insGapTitle: "Le fossé SEO B2B marocain",
    insGapDesc: "Analyse d'opportunité pour les décideurs.",
    insAllTitle: "Tous les articles",
    insAllDesc: "Recherches, analyses et notes de terrain.",
    language: "Langue",
  },
  footer: {
